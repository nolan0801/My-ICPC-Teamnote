...
\teamnote{HUST}{Titanic}{nguyenphong233, tudiv, tuntun}{ICPC Vietnam Regional 2025}
...
\TeamnoteImport{Convex Hull}
{code/Graph/ConvexHull.cpp}
...
%{JusticeHui}
\TeamnoteImport{Heavy Light Decomposition}
{code/Graph/HLD.cpp}

\TeamnoteImport{Centroid Decomposition}
{code/Graph/CentroidDecomp.cpp}
...
\Algorithm{$O(V^2 E)$ Dinic}
{}{}
{cpp}{code/Graph/Dinic.cpp}
%{JusticeHui}

\TeamnoteImport{Manhattan MST}
{code/Graph/ManhattanMST.cpp}
...
\TeamnoteImport{Kuhn Algorithm $O(nm)$}
{code/Graph/KuhnMaxMatchingBipartite.cpp}

\TeamnoteImport{$O(E \log V)$ Directed MST}
{code/Graph/DMST.cpp}

\TeamnoteImport{MCMF CP Algorithm $O(FT)$}
{code/Graph/MCMF-CPAlgo-SFPA.cpp}

\Algorithm{Dinic 2 - CP Algorithm}
{}{}
{cpp}{code/Graph/Dinic-CPAlgo.cpp}
%{edenooo}
...
{}{}
{cpp}{code/Misc/CMakeLists.txt}
{JusticeHui}

\TeamnoteImport{Calendar}
{code/Misc/Calendar.cpp}

\TeamnoteImport{Template}
{code/Misc/DefaultCode.cpp}

\Algorithm{Stress Test}
{}{}
{cpp}{code/Misc/Stress.cpp}
{hoho}
